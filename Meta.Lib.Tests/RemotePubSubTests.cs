...
//        //todo - Dispose
//        static ILogger<PipeTests> CreateLogger()
//        {
...
//            var serverHub = new MetaPubSub(logger);
...
//            var messageReceivedEvent = new ManualResetEventSlim();
//            int recvCount = 0;
...
//            {
//                var hub = CreateServerHub(pipeName);//new MetaPubSub();
...
//            messageReceivedEvent.Wait(5000);

//            // unsubscribing
//            await hub.Unsubscribe<MyMessage>(Handler);
//            Assert.IsTrue(messageReceivedEvent.IsSet && recvCount == 10);
//        }
...
//                var hub = new MetaPubSub();
//                await hub.ConnectToServer(pipeName);
//                await hub.PublishOnServer<MyMessage, MyMessageResponse>(new MyMessage(text));
//            });
...
//            try
//            {
//                await hub.PublishOnServer<MyMessage, MyMessageResponse>(new MyMessage() { DeliverAtLeastOnce = true });
//                notExpectedEvent = 6;
//            }
//            catch (AggregateException ex)
//            {
...
//                await hub.PublishOnServer<PingCommand, MyMessageResponse>(new PingCommand());
...
//                {
//                    await hub.PublishOnServer<PingCommand, MyMessageResponse>(new PingCommand() { Id = i.ToString() });
//                    publishedCount++;
//                }
//            }
//            catch (Exception)
...
//                await hub.PublishOnServer<PingCommand, MyMessageResponse>(new PingCommand() { Id = "321" });
//                await hub.PublishOnServer<PingCommand, MyMessageResponse>(new PingCommand() { Id = "123" });
//            });
...
//            async Task Handler(MyMessage x)
//            {
//                await serverHub.Publish(new MyMessageResponse() { SomeId = x.SomeId, Version = x.Version });
//            }

//            static bool Predicate(MyMessageResponse message)
//            {
...
//            try
//            {
//                await hub.ProcessOnServer<MyMessageResponse>(
...
//            var replay = await hub.ProcessOnServer<MyMessageResponse>(
...
//            try
//            {
//                await hub.PublishOnServer<PingCommand, MyMessageResponse>(new PingCommand() { DeliverAtLeastOnce = true, WaitForSubscriberTimeout = 0 });
//            }
//            catch (NoSubscribersException)
//            {
//            }
...
//            try
//            {
//                await hub.PublishOnServer<PingCommand, MyMessageResponse>(new PingCommand() { DeliverAtLeastOnce = true, WaitForSubscriberTimeout = 100 });
//            }
//            catch (TimeoutException)
//            {
//            }
